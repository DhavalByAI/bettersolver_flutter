...
class Palette {
  ...
  static BoxDecoration loginGradient = const BoxDecoration(
      //borderRadius: BorderRadius.only(topRight: Radius.circular(10.0),bottomRight:Radius.circular(10.0) ),
      gradient: LinearGradient(
  ...
  static BoxDecoration cardShapGradient = const BoxDecoration(
      gradient: LinearGradient(
          begin: Alignment.centerLeft,
          end: Alignment.centerRight,
          colors: [kThemeColorBlue, kThemeColorGreen]),
  ...
  static BoxDecoration RoundGradient = BoxDecoration(
      gradient: const LinearGradient(
          begin: Alignment.centerLeft,
          end: Alignment.centerRight,
          colors: [kThemeColorBlue, kThemeColorGreen]),
  ...
  static BoxDecoration fullRoundGradient = BoxDecoration(
      gradient: const LinearGradient(
          begin: Alignment.centerLeft,
          end: Alignment.centerRight,
          colors: [kThemeColorBlue, kThemeColorGreen]),
  ...
  static Decoration btnDecoration = BoxDecoration(
    border: Border.all(color: kmatblack, width: 3.0),
    borderRadius: BorderRadius.circular(25.0),
    color: kblue,
    boxShadow: const [
  ...
  static BoxDecoration blueBtnDecoration = BoxDecoration(
    border: Border.all(color: kmatblack, width: 3.0),
    borderRadius: BorderRadius.circular(25.0),
    color: kblue,
    boxShadow: const [
  ...
  static BoxDecoration addBtnDecoration = BoxDecoration(
    border: Border.all(color: kmatblack, width: 3.0),
    borderRadius: BorderRadius.circular(25.0),
    color: klightcolor,
    boxShadow: const [
