...
class signupLoginBloc {
  ...
  StreamSink get LoginBlocDataSink =>
      _streamController!.sink;

  Stream get LoginBlocDataStream =>
  ...
  fetchLoginSignupData(
    ...
    try {
      ...
      LoginModel loginData = await _loginRepository!.fetchLogin(
          type, email, password, s.toString(),fcmToken);
      ...
      print("call==== login-signupBLOC3 $_status");
